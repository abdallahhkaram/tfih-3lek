...
const graffitiImage = PlaceHolderImages.find(img => img.id === 'graffiti-wall');
const potholeImage = PlaceHolderImages.find(img => img.id === 'pothole-street');
const brokenLightImage = PlaceHolderImages.find(img => img.id === 'broken-light');

export const mockIncidents: Incident[] = [
  {
    id: '1',
    description: 'Graffiti on the wall of the community center. Needs to be cleaned up.',
  ...
  {
    id: '3',
    description: 'Streetlight is broken near the park entrance. It is very dark at night.',
    photoUrl: brokenLightImage?.imageUrl ?? "https://picsum.photos/seed/3/600/400",
